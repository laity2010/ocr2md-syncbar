...
rm -rf "$APP"
mkdir -p "$MACOS"
xcrun clang -fobjc-arc -framework Cocoa "$ROOT/native/main.m" "$ROOT/native/SyncGroupManager.m" "$ROOT/native/ExclusionEditor.m" "$ROOT/native/ConflictManager.m" -o "$MACOS/OCR2MDSyncStatus"
